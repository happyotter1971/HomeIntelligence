    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Classification */}
          <div className={`flex items-center gap-3 p-4 rounded-lg bg-gray-50 ${getClassificationColor()}`}>
                ...
                <div>
                  ...
                  {evaluation.price_gap.vs_median_ppsf > 0 ? (
                    <span className="text-orange-700">
                      {' '}(${Math.abs(evaluation.price_gap.vs_median_ppsf)} above market)
                    </span>
                  ) : (
                    <span className="text-green-700">
                      {' '}(${Math.abs(evaluation.price_gap.vs_median_ppsf)} below market)
                    </span>
                  )}
                </div>
              </div>
