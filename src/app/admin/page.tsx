              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col justify-center">
                  <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight drop-shadow-xl">
                    <span className="text-honey">Admin Panel</span>
                    <span className="text-white/90">: Access Denied</span>
                  </h1>
      ...
      <div className="relative">
        ...
        <div className="space-y-6">
          ...
          {homes.length === 0 ? (
            ...
            groupedHomes().map(([builderName, builderHomes]) => (
              <Card key={builderName} className="glass-effect border-0 shadow-lg mb-8">
                <CardHeader>
                  <div className="flex items-center justify-between">
